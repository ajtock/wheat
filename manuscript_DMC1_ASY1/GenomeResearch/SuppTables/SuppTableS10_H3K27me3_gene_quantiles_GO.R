...
# Compile H3K27me3 gene quantile GO enrichment analysis results into one supplemental table
...
summaryTableDFList <- lapply(seq_along(quantiles), function(x) {
  Wg <- data.frame(Subgenome = "All",
                   ...
                   read.table(paste0("/home/ajt200/analysis/wheat/ASY1_CS/snakemake_ChIPseq/mapped/geneProfiles_subgenomes/quantiles/",
                                     "quantiles_by_H3K27me3_in_genes/GO/featureIDs_quantile", x, "_of_4_by_H3K27me3_in_genes_of_genes_in_",
...
write.table(summaryTableDF,
            file = "Supplemental_TableS10_H3K27me3_gene_quantiles_GO.tsv",
            col.names = T, row.names = F, sep = "\t", quote = F)
write.csv(summaryTableDF,
          file = "Supplemental_TableS10_H3K27me3_gene_quantiles_GO.csv",
          row.names = F, quote = F)
