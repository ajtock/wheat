...
inDir <- "/home/ajt200/analysis/wheat/ASY1_CS/snakemake_ChIPseq/mapped/geneProfiles_subgenomes/quantiles/quantiles_by_H3K27me3_in_genes/"
...
summaryTableDFList <- mclapply(seq_along(quantiles), function(x) {
  ...
  summaryTableDFList_geneCat2 <- lapply(seq_along(geneCat2), function(w) {
    load(paste0(inDir2,
                ...
                "_of_4_by_log2_H3K27me3_ChIP_SRR6350666_control_in_genes_of_genes_in_Agenome_Bgenome_Dgenome_genomewide_hypergeomTestRes_minConditions6.RData"))
...
colnames(summaryTableDF) <- c("Gene category", "H3K27me3 gene quantile",
...
write.table(summaryTableDF,
            file = "Supplemental_TableS19_H3K27me3_gene_quantiles_hypergeometricTests_homoeologExpressionVariation.tsv",
            col.names = T, row.names = F, sep = "\t", quote = F)
write.csv(summaryTableDF,
          file = "Supplemental_TableS19_H3K27me3_gene_quantiles_hypergeometricTests_homoeologExpressionVariation.csv",
          row.names = F, quote = F)
