...
# Compile H3K27me3 gene quantile GOslim enrichment analysis results into one supplemental table
...
summaryTableDFList <- lapply(seq_along(quantiles), function(x) {
  Wg <- data.frame(Subgenome = "All",
                   ...
                   read.table(paste0("/home/ajt200/analysis/wheat/ASY1_CS/snakemake_ChIPseq/mapped/geneProfiles_subgenomes/quantiles/",
                                     "quantiles_by_H3K27me3_in_genes/GOslim/featureIDs_quantile", x, "_of_4_by_H3K27me3_in_genes_of_genes_in_",
                                     "Agenome_Bgenome_Dgenome_genomewide_GOslim_BP_enrichment.tsv"),
  ...
  Ag <- data.frame(Subgenome = "A",
                   ...
                   read.table(paste0("/home/ajt200/analysis/wheat/ASY1_CS/snakemake_ChIPseq/mapped/geneProfiles_subgenomes/quantiles/",
                                     "quantiles_by_H3K27me3_in_genes/GOslim/featureIDs_quantile", x, "_of_4_by_H3K27me3_in_genes_of_genes_in_",
                                     "Agenome_genomewide_GOslim_BP_enrichment.tsv"),
                                      header = T, sep = "\t", quote = "\"", check.names = F, stringsAsFactors = F),
                   stringsAsFactors = F)
  Bg <- data.frame(Subgenome = "B",
                   ...
                   read.table(paste0("/home/ajt200/analysis/wheat/ASY1_CS/snakemake_ChIPseq/mapped/geneProfiles_subgenomes/quantiles/",
                                     "quantiles_by_H3K27me3_in_genes/GOslim/featureIDs_quantile", x, "_of_4_by_H3K27me3_in_genes_of_genes_in_",
                                     "Bgenome_genomewide_GOslim_BP_enrichment.tsv"),
                                      header = T, sep = "\t", quote = "\"", check.names = F, stringsAsFactors = F),
                   stringsAsFactors = F)
  Dg <- data.frame(Subgenome = "D",
                   ...
                   read.table(paste0("/home/ajt200/analysis/wheat/ASY1_CS/snakemake_ChIPseq/mapped/geneProfiles_subgenomes/quantiles/",
                                     "quantiles_by_H3K27me3_in_genes/GOslim/featureIDs_quantile", x, "_of_4_by_H3K27me3_in_genes_of_genes_in_",
                                     "Dgenome_genomewide_GOslim_BP_enrichment.tsv"),
                                      header = T, sep = "\t", quote = "\"", check.names = F, stringsAsFactors = F),
                   stringsAsFactors = F)
  rbind(Wg, Ag, Bg, Dg)
})
...
colnames(summaryTableDF) <- c("Subgenome", "H3K27me3 gene quantile",
                              "GO ID", "GO term",
                              "Annotated genes in subgenome", "Expected genes in quantile", "Observed genes in quantile", "P")
print(colnames(summaryTableDF))
write.table(summaryTableDF,
            file = "Supplemental_TableS11_H3K27me3_gene_quantiles_GOslim.tsv",
            col.names = T, row.names = F, sep = "\t", quote = F)
write.csv(summaryTableDF,
          file = "Supplemental_TableS11_H3K27me3_gene_quantiles_GOslim.csv",
          row.names = F, quote = F)
