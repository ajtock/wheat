...
# Usage:
# /applications/R/R-3.4.0/bin/Rscript features_sorted_by_log2_ChIP_control_writeGFF3.R ASY1_CS ASY1_CS_Rep1_ChIP H2AZ H2AZ_Rep1_ChIP p0.05_q0.05 2000 2kb '2 kb' 20 20bp bodies 'A' 'euchromatin'

#markName <- "ASY1_CS"
#libName <- "ASY1_CS_Rep1_ChIP"
#featureName <- "H2AZ"
#featureLibName <- "H2AZ_Rep1_ChIP"
...
covMatControl <- mclapply(seq_along(libNameControl), function(x) {
  as.matrix(read.table(paste0(covDirControl[x],
                              ...
                              featureName, "_peaks_in_", genomeName, "genome_", chrRegion,
                              "_matrix_bin", binName,
...
peaksbed <- read.table(paste0("/home/ajt200/analysis/wheat/", featureName,
                              "/snakemake_ChIPseq/mapped/both/peaks/PeakRanger1.18/ranger/", sigLevel, "/",
