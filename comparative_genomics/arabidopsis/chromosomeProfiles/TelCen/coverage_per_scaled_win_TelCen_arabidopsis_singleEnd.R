...
# Usage:
# ./coverage_per_scaled_win_TelCen_arabidopsis_singleEnd.R 'H3K36me3_H3K56ac_H2AZ_leaf_Bewick_Schmitz_2016_PNAS/H3K36me3' H3K36me3 H3K36me3_ChIP_SRR3087130 '170101_Chris_H3K9me2_ChIP/WT' input WT_H3K9me2_Rep1_input_R1 both 10kb 10000 100 100ths darkorange2

#dirChIPA <- "170920_Chris_histone_ChIP/H3K27me3"
#markChIPA <- "H3K27me3"
#libNameChIPA <- "WT_H3K27me3_ChIP"
#dirControlA <- "170101_Chris_H3K9me2_ChIP/WT"
#markControlA <- "input"
#libNameControlA <- "WT_H3K9me2_Rep1_input_R1"
#align <- "both"
#winName <- "10kb"
#winSize <- 10000
#prop <- 100
#propName <- "100ths" 
#profileColour <- "darkorange2"
