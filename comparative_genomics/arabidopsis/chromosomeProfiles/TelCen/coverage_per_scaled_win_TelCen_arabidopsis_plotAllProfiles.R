...
# Usage:
# ./coverage_per_scaled_win_TelCen_arabidopsis_plotAllProfiles.R both 10kb 100 100ths 3 
...
profileNames <- c(
                  "log2_WT_H3K4me3_ChIP14_WT_H3K9me2_Rep1_input",
                  "log2_H3K9ac_30d_ChIP_SRR1964985_H3K9ac_30d_input_SRR1964986",
                  "log2_H2AZ_ChIP_SRR2922644_WT_H3K9me2_Rep1_input_R1",
                  "log2_H3K36me3_ChIP_SRR3087130_WT_H3K9me2_Rep1_input_R1",
                  "log2_WT_MNase_Rep1_WT_gDNA_Rep1",
                  "log2_WT_H3K27me1_ChIP_WT_histone_input",
                  "log2_WT_H3K27me3_ChIP_WT_histone_input",
                  "log2_WT_H3K9me2_Rep1_ChIP_WT_H3K9me2_Rep1_input"
                 )
profileNamesPlot <- c(
                      "H3K4me3",
                      "H3K9ac",
...
pdf(paste0("./Arabidopsis_Zscore_log2_ChIPinput_",
           align, "_", winName, "_",
           propName, "_smooth", N,
           "_TelCenProfile.pdf"),
    height = 7, width = 7)
...
TelCenPlot(xplot = 1:length(TelCenProfiles[[1]]),
           ...
           Ylim = c(min(c(TelCenProfiles[[1]], TelCenProfiles[[2]], TelCenProfiles[[3]],
                          ...
                          TelCenProfiles[[7]], TelCenProfiles[[8]])),
...
TelCenPlot(xplot = 1:length(filt_TelCenProfiles[[1]]),
           ...
           Ylim = c(min(c(filt_TelCenProfiles[[1]], filt_TelCenProfiles[[2]], filt_TelCenProfiles[[3]],
                          ...
                          filt_TelCenProfiles[[7]], filt_TelCenProfiles[[8]])),
