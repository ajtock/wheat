...
# Usage:
# ./chrProfilePlot_1homoeologuegroup_log2_histoneMod_IWGSCinput_x2_NLRs_stress_response_genes_v2.R H3K27me1 H3K27me1_Rep1_ChIP H3K27me3 H3K27me3_ChIP_SRR6350666 MNase MNase_Rep1 input H3_input_SRR6350669 both 1Mb 1000000 15 firebrick1 navy 180220 Gypsy_LTR_RLG 'chr3A,chr3B,chr3D'
...
featureB <- read.table(paste0("/home/ajt200/analysis/wheat/chromosomeProfiles/genes/stress_response_gene_frequency_per_",
                              winName, ".txt"),
                       header = T)
