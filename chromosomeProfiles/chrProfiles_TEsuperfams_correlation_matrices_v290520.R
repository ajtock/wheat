...
# Usage:
# ./chrProfiles_TEsuperfams_correlation_matrices_v290520.R 1Mb 1000000 genomewide 'A,B,D' smoothed 290520
...
#            mapping = aes(X2, X1, label = value), size = 10) +
  ...
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, vjust = 0.5, hjust = 0, size = 46, colour = "black"),
        axis.text.y = element_text(angle = 0, vjust = 1, hjust = 1, size = 46, colour = "black"),
...
ggsave(paste0(plotDir,
              ...
              "_log2ChIPcontrol_cMMb_genes_TEsuperfams_in_",
              paste0(genomeName, collapse = "_"), "_genome_", region, "_", smoothing, "_v", date, ".pdf"),
