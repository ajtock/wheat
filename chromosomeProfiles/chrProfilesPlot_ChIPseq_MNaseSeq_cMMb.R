...
# Usage:
# ./chrProfilesPlot_ChIPseq_MNaseSeq_cMMb.R H3K4me3 H3K4me3_Rep1_ChIP both 1Mb 1000000 15 forestgreen 291118 48
...
for(x in 1:length(filt_chrProfiles)) {
  chrPlotCov_cMMb(xplot1 = filt_chrProfiles[[x]]$window,
