...
# Usage:
# ./chrProfilePlot_1homoeologuegroup_DNAmeth_MNase_cMMb_TEsuperfam.R input H3_input_SRR6350669 BSseq_Rep8a_SRR6792678 Gypsy_LTR_RLG both 1Mb 1000000 15 darkcyan 120520 'chr3A,chr3B,chr3D'
...
#markChIPA <- "input"
#libNameChIPA <- "H3_input_SRR6350669"
