...
# Usage:
# ./chrProfilesPlot_ChIPseq_MNaseSeq_cMMb_equivWins.R H3K4me3 H3K4me3_Rep1_ChIP both 1Mb 1000000 15 forestgreen 291118 48
...
profileFeature <- read.table("/home/ajt200/analysis/wheat/chromosomeProfiles/cMMb/log2_cMMb_iwgsc_refseqv1.0_mapping_data_1Mb.txt",
                             header = T) 
...
pdf(paste0(plotDir, "Wheat_", libNameChIP, "_",
           align, "_log2_cMMb_equivWins_chrPlot_winSize", winName, "_smooth", N,
           "_v", date, ".pdf"),
    height = 21, width = 30)
par(mfrow = c(7, 3))
