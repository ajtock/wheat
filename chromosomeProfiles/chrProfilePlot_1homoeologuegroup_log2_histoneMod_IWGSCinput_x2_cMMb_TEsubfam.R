...
# Change xblocks height to 12.0 in chrPartitionPlotCov2_feature2 function

# Usage:
# ./chrProfilePlot_1homoeologuegroup_log2_histoneMod_IWGSCinput_x2_cMMb_TEsubfam.R CENH3 CENH3_ChIP_SRR1686799 ASY1_CS ASY1_CS_Rep1_ChIP input H3_input_SRR6350669 input H3_input_SRR6350669 both 1Mb 1000000 15 dodgerblue purple4 180220 'Gypsy_LTR_RLG_subfamily_RLG_famc8.3' 'chr3A,chr3B,chr3D'
...
featureA <- read.table(paste0("/home/ajt200/analysis/wheat/chromosomeProfiles/cMMb/cMMb_iwgsc_refseqv1.0_mapping_data_minInterMarkerDist",
                              "200bp_", winName, ".txt"),
                       header = T)
featureB <- read.table(paste0("/home/ajt200/analysis/wheat/chromosomeProfiles/TEs/subfamilies/TE_frequency_per_",
...
pdf(paste0(plotDir, "Wheat_", paste0(chrName, collapse = "_"),
           ...
           align, "_featureFreq_", superfam, "_chrPlot_winSize", winName, "_smooth", N,
           "_v", date, ".pdf"),
...
for(x in which(chrs %in% chrName)) {
  chrPartitionPlotCov2_feature2(chrx = which(chrs %in% chrName),
                                ...
                                legendLabs = c(sub("_\\w+", "", markChIPA), sub("_\\w+", "", markChIPB), "cM/Mb", "Cereba LTRs"),
