...
# Usage:
# ./log2ChIPcontrol_coverage_per_scaled_win_TelCen_plotAllProfiles_noZscore_altColours_shortArm_longArm.R both 1Mb 100 100ths 3 
...
TelCenPlot <- function(xplot,
  ...
  par(new = T, mgp = c(3, 0.5, 0))
  plot(xplot, profiles[[9]], type = "l", lwd = 3, lty = 2, col = profileColours[9],
  ...
  par(new = T, mgp = c(3, 0.5, 0))
  plot(xplot, profiles[[10]], type = "l", lwd = 3, lty = 1, col = profileColours[10],
...
pdf(paste0(plotDir, "log2ChIPcontrol_",
           align, "_", winName, "_",
           propName, "_smooth", N,
           "_shortArm_longArm_TelCenProfile_v060421_reordered_altColours.pdf"),
    height = 7, width = 11)
par(mfrow = c(2, 1))
