...
# Usage:
# ./defense_response_genes_per_scaled_win_TelCen.R 1Mb 1000000 100 100ths grey50
...
profiles <- read.table(paste0("/home/ajt200/analysis/wheat/chromosomeProfiles/",
                              "genes/defense_response_gene_frequency_per_", winName, "_unsmoothed.txt"),
                       header = T)
...
write.table(TelCenMatrix,
            file = paste0("defense_response_genes_",
                          winName, "_",
                          propName, "_TelCenMatrix.txt"))

# Load TelCenMatrix
TelCenDF <- read.table(paste0("defense_response_genes_",
                              winName, "_",
                              propName, "_TelCenMatrix.txt"))
...
pdf(paste0(plotDir, "defense_response_genes_",
           winName, "_",
