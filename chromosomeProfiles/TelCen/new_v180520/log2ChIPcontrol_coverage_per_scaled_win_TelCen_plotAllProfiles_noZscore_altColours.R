...
# Usage:
# ./log2ChIPcontrol_coverage_per_scaled_win_TelCen_plotAllProfiles_noZscore_altColours.R both 1Mb 100 100ths 3 
...
pdf(paste0(plotDir, "log2ChIPcontrol_",
           align, "_", winName, "_",
           propName, "_smooth", N,
           "_TelCenProfile_v200720_reordered_altColours.pdf"),
    height = 7, width = 10)
par(mfrow = c(2, 1))
