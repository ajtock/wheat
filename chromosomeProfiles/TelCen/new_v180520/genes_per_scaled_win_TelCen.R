...
# Usage:
# ./genes_per_scaled_win_TelCen.R 1Mb 1000000 100 100ths grey50
...
profiles <- read.table(paste0("/home/ajt200/analysis/wheat/chromosomeProfiles/",
                              "genes/gene_frequency_per_", winName, "_unsmoothed.txt"),
                       header = T)
...
# Load TelCenMatrix
TelCenDF <- read.table(paste0("genes_",
                              winName, "_",
                              propName, "_TelCenMatrix.txt"))
