...
# Usage:
# ./others_vs_DMC1_heterochromatin_peaks_bargraphs.R "Heterochromatin DMC1 peaks" "A genome" "B genome" "D genome" Agenome Bgenome Dgenome Agenome heterochromatin 10000
...
otherNamesPlot <- otherNamesPlot[1:14]
...
ptOrder <- ptPeaksOtherPerChrom[1:14]
