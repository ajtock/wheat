...
# Usage:
# ./DMC1_Rep1_ChIP_peaks_ranLoc_read_counts_RPKM.R DMC1_Rep1_ChIP DMC1 'Agenome_distal,Bgenome_distal,Dgenome_distal,Agenome_interstitial,Bgenome_interstitial,Dgenome_interstitial,Agenome_proximal,Bgenome_proximal,Dgenome_proximal' 'chr3B'
