...
# Usage:
# /applications/R/R-3.5.0/bin/Rscript quantile_peaks_cMMb_density_plot_v050620.R cMMb DMC1_Rep1_ChIP DMC1 'Agenome_euchromatin,Bgenome_euchromatin,Dgenome_euchromatin' 4
