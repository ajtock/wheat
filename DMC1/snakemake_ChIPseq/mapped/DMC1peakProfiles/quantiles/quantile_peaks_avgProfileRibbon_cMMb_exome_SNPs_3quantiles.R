...
# Usage:
# csmit -m 50G -c 3 "/applications/R/R-3.5.0/bin/Rscript quantile_peaks_avgProfileRibbon_cMMb_exome_SNPs_3quantiles.R DMC1_Rep1_ChIP DMC1 'Agenome_heterochromatin,Bgenome_heterochromatin,Dgenome_heterochromatin' cMMb 3 both 400 2000 2kb 20 '0.02,0.96'"
