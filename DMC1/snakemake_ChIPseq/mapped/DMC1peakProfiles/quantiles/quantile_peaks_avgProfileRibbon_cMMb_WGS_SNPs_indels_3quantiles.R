...
# Usage:
# csmit -m 100G -c 15 "/applications/R/R-3.5.0/bin/Rscript quantile_peaks_avgProfileRibbon_cMMb_WGS_SNPs_indels_3quantiles.R DMC1_Rep1_ChIP DMC1 'Agenome_heterochromatin,Bgenome_heterochromatin,Dgenome_heterochromatin' cMMb 3 both 400 2000 2kb 20 '0.02,0.96'"
