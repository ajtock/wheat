...
# Usage:
# /applications/R/R-3.5.0/bin/Rscript quantile_peaks_cMMb_density_plot_v050620_3quantiles.R cMMb DMC1_Rep1_ChIP DMC1 'Agenome_heterochromatin,Bgenome_heterochromatin,Dgenome_heterochromatin' 3
...
minDensity <- 0
maxDensity <- max(density(featuresDF[featuresDF$quantile == "Quantile 3",]$cMMb,
                          na.rm = T)$y)+0.04
maxDensity <- max(
  c(
