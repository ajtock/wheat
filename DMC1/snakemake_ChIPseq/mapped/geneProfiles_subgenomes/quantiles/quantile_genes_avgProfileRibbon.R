...
# Usage:
# /applications/R/R-3.5.0/bin/Rscript quantile_genes_avgProfileRibbon.R DMC1_Rep1_ChIP DMC1 both 'genes_in_Agenome_genomewide,genes_in_Bgenome_genomewide,genes_in_Dgenome_genomewide' 3500 2000 2kb '2 kb' 20 20bp promoters 4 100kb 1 '0.75,0.96'
