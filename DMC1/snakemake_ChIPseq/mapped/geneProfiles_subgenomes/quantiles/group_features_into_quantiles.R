...
# Usage:
# /applications/R/R-3.4.0/bin/Rscript group_features_into_quantiles.R DMC1_Rep1_ChIP DMC1 both 'genes_in_Agenome_genomewide,genes_in_Bgenome_genomewide,genes_in_Dgenome_genomewide' 3500 2000 2kb '2 kb' 20 20bp promoters 4 100kb 1
