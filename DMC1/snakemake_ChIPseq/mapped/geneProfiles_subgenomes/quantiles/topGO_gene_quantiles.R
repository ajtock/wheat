...
# Usage:
# /applications/R/R-3.5.0/bin/Rscript ./topGO_gene_quantiles.R BP 0.1 'log2_DMC1_Rep1_ChIP_control_in_promoters' 1 4 'genomewide' 'Agenome_Bgenome_Dgenome'

# Doesn't work with mclapply or dopar

#ont <- "BP"
#sigLevel <- 0.1
#quantileBy <- "log2_DMC1_Rep1_ChIP_control_in_promoters"
#quantileFirst <- 1
#quantileLast <- 4
#region <- "genomewide"
#genomeName <- "A"
