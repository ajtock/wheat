...
# Usage:
# /applications/R/R-3.4.0/bin/Rscript features_heatmap_sorted_kmeans.R DMC1_Rep1_ChIP DMC1 both genes_in_Agenome_genomewide 3500 2000 2kb '2 kb' 20 20bp promoters
