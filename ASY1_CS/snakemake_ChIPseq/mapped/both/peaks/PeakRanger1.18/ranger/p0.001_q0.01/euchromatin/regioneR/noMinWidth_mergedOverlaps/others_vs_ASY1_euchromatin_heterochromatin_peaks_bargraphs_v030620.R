...
# Usage:
# ./others_vs_ASY1_euchromatin_heterochromatin_peaks_bargraphs_v030620.R "ASY1 peaks" Agenome Bgenome Dgenome Agenome 10000

library(ggplot2)
library(ggthemes)

#plotTitle <- "ASY1 peaks"
#pt1LibName <- "Agenome" 
#pt2LibName <- "Bgenome"
#pt3LibName <- "Dgenome"
...
load(paste0(euDir, "permTest_", perms, "perms_ASY1_CS_Rep1_ChIP_peaks_vs_others_in_",
...
load(paste0(heteroDir, "permTest_", perms, "perms_ASY1_CS_Rep1_ChIP_peaks_vs_others_in_",
