...
# Usage:
# ./TEfams_vs_ASY1_CS_euchromatin_peaks_bargraphs_2genomes.R "Euchromatin ASY1 peaks" "B genome" "D genome" Bgenome Dgenome Bgenome euchromatin 10000
