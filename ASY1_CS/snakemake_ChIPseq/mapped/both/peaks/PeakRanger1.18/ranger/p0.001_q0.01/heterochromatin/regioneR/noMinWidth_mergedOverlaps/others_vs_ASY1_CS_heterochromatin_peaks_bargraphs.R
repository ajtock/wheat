...
# Usage:
# ./others_vs_ASY1_CS_heterochromatin_peaks_bargraphs.R "Heterochromatin ASY1 peaks" "A genome" "B genome" "D genome" Agenome Bgenome Dgenome Agenome heterochromatin 10000
