...
# Plot bar graph of log2(observed:expected) peaks overlapping TEfam features

# Usage:
# ./TEfams_vs_ASY1_CS_heterochromatin_peaks_bargraphs_1genome.R "Heterochromatin ASY1 peaks" "D genome" Dgenome Dgenome heterochromatin 10000

library(ggplot2)
library(ggthemes)

#plotTitle <- "Heterochromatin ASY1 peaks"
#pt1Name <- "D genome"
#pt1LibName <- "Dgenome"
#ptOrderLibName <- "Dgenome"
