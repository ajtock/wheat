...
# Usage:
# ./bedtools_getfasta.sh 161010_Chinese_Spring_v1.0_pseudomolecules.fasta ASY1_CS_Rep1_ChIP_peaks_minuslog10Qsorted_in_Agenome_heterochromatin_summits200bp 
