...
# Usage:
# python3 ./split_pwm.py ./ASY1_CS_Rep1_ChIP_peaks_minuslog10Qsorted_in_Agenome_euchromatin_summits200bp.fa.matrix.w2
...
#os.chdir("/home/ajt200/analysis/wheat/ASY1_CS/snakemake_ChIPseq/mapped/both/peaks/PeakRanger1.18/ranger/p0.001_q0.01/euchromatin/motifs_summits200bp/weeder2_bg_ranLoc_200bpseq/A/top10000")
print(os.getcwd())
#infile = open("./ASY1_CS_Rep1_ChIP_peaks_minuslog10Qsorted_in_Agenome_euchromatin_summits200bp.fa.matrix.w2")
#matrix_file = "./ASY1_CS_Rep1_ChIP_peaks_minuslog10Qsorted_in_Agenome_euchromatin_summits200bp.fa.matrix.w2"
