...
# Usage:
# ./TEfams_vs_ASY1_CS_heterochromatin_peaks_bargraphs_2genomes.R "Heterochromatin ASY1 peaks" "B genome" "D genome" Bgenome Dgenome Bgenome heterochromatin 10000
