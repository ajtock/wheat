...
# Usage:
# /applications/R/R-3.4.0/bin/Rscript features_EnrichedHeatmap_sorted_by_log2_ASY1_CS_Rep1_ChIP_control.R ASY1_CS_Rep1_ChIP ASY1_CS_peaks_in_Agenome_euchromatin 2000 2kb '2 kb' 20 20bp bodies
