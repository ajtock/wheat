...
# Usage:
# /applications/R/R-3.4.0/bin/Rscript features_sorted_by_log2_ASY1_CS_Rep1_ChIP_control_writeGFF3.R ASY1_CS_Rep1_ChIP ASY1_CS_peaks_in_Agenome_euchromatin 2000 2kb '2 kb' 20 20bp bodies 'A' 'euchromatin'
...
peaksbed <- read.table(paste0("/home/ajt200/analysis/wheat/ASY1_CS/snakemake_ChIPseq/mapped/both/peaks/PeakRanger1.18/ranger/p0.001_q0.01/",
                              libName,
