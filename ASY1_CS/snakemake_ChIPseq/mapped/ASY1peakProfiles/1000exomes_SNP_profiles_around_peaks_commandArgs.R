...
# csmit -m 50G -c 1 "/applications/R/R-3.4.0/bin/Rscript ./1000exomes_SNP_profiles_around_peaks_commandArgs.R ASY1_CS_Rep1_ChIP euchromatin A 400 2000 2kb 20"
...
outDF <- list(paste0(matDir,
                     "exome_all_SNPs_around_ASY1_CS_peaks_in_", genomeName, "genome_", region,
...
# Define matrix and column mean frequency outfile (mean profiles)
outDF <- list(paste0(matDir,
                     "exome_transition_SNPs_around_ASY1_CS_peaks_in_", genomeName, "genome_", region,
                     "_matrix_bin", winSize, "bp_flank", flankName, ".tab"),
              paste0(matDir,
                     "exome_transition_SNPs_around_ASY1_CS_peaks_in_", genomeName, "genome_", region,
                     "_ranLoc_matrix_bin", winSize, "bp_flank", flankName, ".tab"))
...
# Define matrix and column mean frequency outfile (mean profiles)
outDF <- list(paste0(matDir,
                     "exome_transversion_SNPs_around_ASY1_CS_peaks_in_", genomeName, "genome_", region,
                     "_matrix_bin", winSize, "bp_flank", flankName, ".tab"),
              paste0(matDir,
                     "exome_transversion_SNPs_around_ASY1_CS_peaks_in_", genomeName, "genome_", region,
                     "_ranLoc_matrix_bin", winSize, "bp_flank", flankName, ".tab"))
