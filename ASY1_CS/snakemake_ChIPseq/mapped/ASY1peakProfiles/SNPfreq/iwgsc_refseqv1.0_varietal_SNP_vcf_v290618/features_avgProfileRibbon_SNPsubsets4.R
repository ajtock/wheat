...
# Usage:
# /applications/R/R-3.5.0/bin/Rscript features_avgProfileRibbon_SNPsubsets4.R ASY1_CS_Rep1_ChIP_peaks 'ASY1 peaks' 2000 2kb '2 kb' 20 20bp 'A' 'euchromatin' 'HIGH,MODERATE,MODIFIER,LOW' 'High,Moderate,Modifier,Low' 'red,orange,green,darkgreen' '0.02,0.94'

#'all,upstream_gene_variant,downstream_gene_variant'
