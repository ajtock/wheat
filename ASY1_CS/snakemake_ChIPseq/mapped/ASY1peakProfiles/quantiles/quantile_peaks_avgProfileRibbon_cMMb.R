...
# Usage:
# /applications/R/R-3.5.0/bin/Rscript quantile_peaks_avgProfileRibbon_cMMb.R cMMb 'cM/Mb' both 'ASY1_CS_peaks_in_Agenome_euchromatin,ASY1_CS_peaks_in_Bgenome_euchromatin,ASY1_CS_peaks_in_Dgenome_euchromatin' 3500 2000 2kb '2 kb' 20 20bp bodies 4 100kb 1 '0.02,0.96'

#orderingFactor <- "cMMb"
#dirName <- "cM/Mb"
#align <- "both"
#featureName <- unlist(strsplit("ASY1_CS_peaks_in_Agenome_euchromatin,ASY1_CS_peaks_in_Bgenome_euchromatin,ASY1_CS_peaks_in_Dgenome_euchromatin",
#                               split = ","))
#bodyLength <- 3500
#upstream <- 2000
#downstream <- 2000
...
otherDirs <- sapply(seq_along(otherNames), function(x) {
  if(otherNames[x] %in% c("MNase_Rep1")) {
    ...
    paste0("/home/ajt200/analysis/wheat/",
           otherNamesDir[x], "/snakemake_RNAseq_HISAT2/mapped/ASY1peakProfiles/matrices/")
  } else {
...
DNAmethDirs <- sapply(seq_along(DNAmethNames), function(x) {
  if(DNAmethNames[x] %in% c("BSseq_Rep8a_SRR6792678")) {
    paste0("/home/ajt200/analysis/wheat/epigenomics_shoot_leaf_IWGSC_2018_Science/",
           DNAmethNamesDir[x],
           "/snakemake_BSseq/coverage/ASY1peakProfiles/matrices/")
  } else {
...
#              "_by_", orderingFactor, "_of_",
#              substring(featureName[1][1], first = 1, last = 5), "_in_",
#              paste0(substring(featureName, first = 10, last = 16),
#                     collapse = "_"), "_",
#              substring(featureName[1][1], first = 18), "_v140420.pdf"),
