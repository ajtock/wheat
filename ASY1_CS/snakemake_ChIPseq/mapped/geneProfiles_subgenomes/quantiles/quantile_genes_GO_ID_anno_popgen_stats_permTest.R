...
#                             "MWW test"  ~ italic("P") ~ .(UtestPvalChar)))))
  ...
  ggsave(paste0(plotDir[x],
                ...
                "_ann_with_GO_BP_enrichment_GO_", GO_ID, "_meanLSD_v010720.pdf"),
...
#                            collapse = "_"), "_",
#                     substring(featureName[1][1], first = 18),
#                     "_ann_with_GO_BP_enrichment_GO_", GO_ID, "_v010720.RData"))
#  } else {
#  save(nonIDs_permTestResults,
#       file = paste0(outDir[x],
#                     orderingFactor, "_", pop_name[x], "_random_nonIDs_permTest_for_", gsub(" ", "_", featureNamePlot),
...
#                    collapse = "_"), "_",
#             substring(featureName[1][1], first = 18),
#             "_ann_with_GO_BP_enrichment_GO_", GO_ID, "_hist_v010720.pdf"),
#             height = 4.5, width = 5)
#  } else {
#  pdf(paste0(plotDir[x],
#             orderingFactor, "_", pop_name[x], "_random_nonIDs_permTest_for_", gsub(" ", "_", featureNamePlot),
...
#                     collapse = "_"), "_",
#              substring(featureName[1][1], first = 18),
#              "_ann_with_GO_BP_enrichment_GO_", GO_ID, "_v010720.pdf"),
#       plot = bp,
#       height = 8, width = 14)
#} else {
#ggsave(paste0(sub("\\w+\\/$", "", outDir[1]), "plots/",
