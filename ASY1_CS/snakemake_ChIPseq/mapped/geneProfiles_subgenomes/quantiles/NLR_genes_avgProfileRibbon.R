...
# Usage:
# /applications/R/R-3.5.0/bin/Rscript NLR_genes_avgProfileRibbon.R ASY1_CS_Rep1_ChIP ASY1_CS both 'genes_in_Agenome_genomewide,genes_in_Bgenome_genomewide,genes_in_Dgenome_genomewide' 'NLR-encoding_genes' 3500 2000 2kb '2 kb' 20 20bp promoters
...
features_NLRs <- features[features$V1 %in% NLRs$V1 &
                          features$V4 %in% NLRs$V4 &
                          features$V5 %in% NLRs$V5 &
                          features$V7 %in% NLRs$V7,]
