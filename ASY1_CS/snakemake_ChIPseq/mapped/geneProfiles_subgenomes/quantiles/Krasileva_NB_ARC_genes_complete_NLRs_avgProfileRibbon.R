...
# Plot average coverage profiles with 95% CIs around NLR-encoding genes

# Usage:
# /applications/R/R-3.5.0/bin/Rscript Krasileva_NB_ARC_genes_complete_NLRs_avgProfileRibbon.R ASY1_CS_Rep1_ChIP ASY1_CS both 'genes_in_Agenome_genomewide,genes_in_Bgenome_genomewide,genes_in_Dgenome_genomewide' 'NLR-encoding_genes' 3500 2000 2kb '2 kb' 20 20bp promoters
...
#                               split = ","))
#featureNamePlot <- "NLR-encoding_genes"
#bodyLength <- 3500
#upstream <- 2000
#downstream <- 2000
#flankName <- "2kb"
...
# Load NLRs
NLRs <- read.table("/home/ajt200/analysis/wheat/annotation/221118_download/iwgsc_refseqv1.1_genes_2017July06/NLRs_Krasileva/NB_ARC_genes_complete_NLRs_IWGSC_v1_Ksenia_Krasileva_representative_mRNA.gff3", header = F)
...
ggsave(paste0(plotDir,
              ...
              paste0(substring(featureName, first = 10, last = 16),
                     collapse = "_"), "_",
              substring(featureName[1][1], first = 18), "_v170120.pdf"),
