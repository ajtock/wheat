...
############################################
# Analyse genes for GOslim term enrichment #
...
# Usage:
# /applications/R/R-3.5.0/bin/Rscript ./topGOslim_gene_quantiles.R BP 0.1 'log2_ASY1_CS_Rep1_ChIP_control_in_bodies' 1 4 'genomewide' 'Agenome_Bgenome_Dgenome'
...
# Read in GOslim annotations for genes to define "gene universe"
