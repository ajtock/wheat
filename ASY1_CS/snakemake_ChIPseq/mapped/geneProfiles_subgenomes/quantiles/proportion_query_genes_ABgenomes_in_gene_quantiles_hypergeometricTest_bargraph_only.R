...
# Usage 
# ./proportion_query_genes_ABgenomes_in_gene_quantiles_hypergeometricTest_bargraph_only.R 'ASY1_CS_Rep1_ChIP' 'bodies' 1 4 'genomewide' IGR_overlapping 'IGR-overlapping' 100000 'darkorange,gold'
# ./proportion_query_genes_ABgenomes_in_gene_quantiles_hypergeometricTest_bargraph_only.R 'ASY1_CS_Rep1_ChIP' 'bodies' 1 4 'genomewide' SGR_overlapping 'SGR-overlapping' 100000 'turquoise4,turquoise2'
...
#quantileLast <- 4
#region <- "genomewide"
#featCat <- "IGR_overlapping"
#featCatPlot <- "IGR-overlapping"
#samplesNum <- 100000
...
bargraph_df <- data.frame(Subgenome = rep(c("A genome", "B genome"), each = quantileLast),
