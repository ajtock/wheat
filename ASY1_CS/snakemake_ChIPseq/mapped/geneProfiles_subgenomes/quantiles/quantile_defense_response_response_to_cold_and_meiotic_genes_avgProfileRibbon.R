...
# Plot average coverage profiles with 95% CIs around genes
# within given functional categories in gene quantiles

# Usage:
# /applications/R/R-3.5.0/bin/Rscript quantile_defense_response_response_to_cold_and_meiotic_genes_avgProfileRibbon.R cMMb cMMb both 'genes_in_Agenome_genomewide,genes_in_Bgenome_genomewide,genes_in_Dgenome_genomewide' 3500 2000 2kb '2 kb' 20 20bp genes 4 100kb 1 '0.02,0.96'
...
# Define plot titles
subcat1NamePlot <- paste0("Defense in ",
                          sub("_\\w+", "", dirName),
                          " quantiles")
...
subcat1_IDs <- anno[defense_response_indices,]$featureID
subcat1_IDs <- subcat1_IDs[!(subcat1_IDs %in% unique(c(subcat1b_IDs, subcat1c_IDs)))]
...
if(libName %in% c("cMMb", "HudsonRM_all", "HudsonRM_syn", "HudsonRM_nonsyn")) {
  ggsave(paste0(plotDir,
                ...
                paste0(substring(featureName, first = 10, last = 16),
                       collapse = "_"), "_",
                substring(featureName[1][1], first = 18), "_Defense_response_Cold_response_Meiotic_genes_v020720.pdf"),
