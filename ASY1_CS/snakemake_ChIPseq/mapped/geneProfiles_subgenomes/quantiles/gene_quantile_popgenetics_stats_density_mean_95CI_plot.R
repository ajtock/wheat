...
# Usage:
#/applications/R/R-3.5.0/bin/Rscript gene_quantile_popgenetics_stats_density_mean_95CI_plot.R DMC1_Rep1_ChIP DMC1 'genes_in_Agenome_genomewide,genes_in_Bgenome_genomewide,genes_in_Dgenome_genomewide' genes 4 TajimaD_all "Tajima's D" 0.99 0.2 '%1.1f' '%1.1f' '%1.2f' 0.65

#/applications/R/R-3.5.0/bin/Rscript gene_quantile_popgenetics_stats_density_mean_95CI_plot.R DMC1_Rep1_ChIP DMC1 'genes_in_Agenome_genomewide,genes_in_Bgenome_genomewide,genes_in_Dgenome_genomewide' genes 4 RozasR2_all "Rozas' R 2" 0.90 0.2 '%1.2f' '%2.0f' '%2.0f' 0.38

#/applications/R/R-3.5.0/bin/Rscript gene_quantile_popgenetics_stats_density_mean_95CI_plot.R DMC1_Rep1_ChIP DMC1 'genes_in_Agenome_genomewide,genes_in_Bgenome_genomewide,genes_in_Dgenome_genomewide' genes 4 CLR_all "CLR" 0.90 0.005 '%1.0f' '%1.2f' '%1.0f' 0.65

#/applications/R/R-3.5.0/bin/Rscript gene_quantile_popgenetics_stats_density_mean_95CI_plot.R DMC1_Rep1_ChIP DMC1 'genes_in_Agenome_genomewide,genes_in_Bgenome_genomewide,genes_in_Dgenome_genomewide' genes 4 HudsonRM_all "Hudson's R M" 0.90 0.2 '%1.1f' '%2.0f' '%1.2f' 0.38

#/applications/R/R-3.5.0/bin/Rscript gene_quantile_popgenetics_stats_density_mean_95CI_plot.R DMC1_Rep1_ChIP DMC1 'genes_in_Agenome_genomewide,genes_in_Bgenome_genomewide,genes_in_Dgenome_genomewide' genes 4 nucleotideDiversity_all "Diversity pi" 0.75 0.2 '%1.3f' '%3.0f' '%1.3f' 0.65

#/applications/R/R-3.5.0/bin/Rscript gene_quantile_popgenetics_stats_density_mean_95CI_plot.R DMC1_Rep1_ChIP DMC1 'genes_in_Agenome_genomewide,genes_in_Bgenome_genomewide,genes_in_Dgenome_genomewide' genes 4 nSegregatingSites_all "Norm. seg. sites" 0.99 0.05 '%1.1f' '%1.1f' '%1.1f' 0.65
