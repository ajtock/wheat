...
# Usage:
# /applications/R/R-3.5.0/bin/Rscript quantile_translation_GO_genes_popgen_stats_permTest.R ASY1_CS_Rep1_ChIP ASY1_CS 'genes_in_Agenome_genomewide,genes_in_Bgenome_genomewide,genes_in_Dgenome_genomewide' 'Translation_genes' '0006412' bodies 1 4 TajimaD 'Tajima D' 10000 0.0001

#libName <- "ASY1_CS_Rep1_ChIP"
#dirName <- "ASY1_CS"
#featureName <- unlist(strsplit("genes_in_Agenome_genomewide,genes_in_Bgenome_genomewide,genes_in_Dgenome_genomewide",
#                               split = ","))
#featureNamePlot <- "Translation_genes"
#GO_ID <- "0006412"
#region <- "bodies"
#quantileNo <- 1
#quantiles <- 4
...
#annoGOIDs <- anno[unique(c(which(grepl(pattern = "translation",
