...
# Usage:
# /applications/R/R-3.5.0/bin/Rscript quantile_genes_avgProfileRibbon_cMMb_WGS_SNPs_indels.R cMMb 'cM/Mb' both 'genes_in_Agenome_genomewide,genes_in_Bgenome_genomewide,genes_in_Dgenome_genomewide' 3500 2000 2kb '2 kb' 20 20bp genes 4 100kb 1 '0.02,0.96'
