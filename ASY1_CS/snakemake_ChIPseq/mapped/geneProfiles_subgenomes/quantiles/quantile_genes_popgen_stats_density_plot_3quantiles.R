...
# Usage:
#/applications/R/R-3.5.0/bin/Rscript quantile_genes_popgen_stats_density_plot_2quantiles.R HudsonRM_all HudsonRM_all 'genes_in_Agenome_genomewide,genes_in_Bgenome_genomewide,genes_in_Dgenome_genomewide' bodies 3 TajimaD_all "Tajima's D" 0.99 0.2 '%1.1f' '%1.1f' '%1.2f' 0.65

#/applications/R/R-3.5.0/bin/Rscript quantile_genes_popgen_stats_density_plot_2quantiles.R HudsonRM_all HudsonRM_all 'genes_in_Agenome_genomewide,genes_in_Bgenome_genomewide,genes_in_Dgenome_genomewide' bodies 3 RozasR2_all "Rozas' R 2" 0.90 0.2 '%1.2f' '%2.0f' '%2.0f' 0.38

#/applications/R/R-3.5.0/bin/Rscript quantile_genes_popgen_stats_density_plot_2quantiles.R HudsonRM_all HudsonRM_all 'genes_in_Agenome_genomewide,genes_in_Bgenome_genomewide,genes_in_Dgenome_genomewide' bodies 3 CLR_all "CLR" 0.90 0.005 '%1.0f' '%1.2f' '%1.0f' 0.65

#/applications/R/R-3.5.0/bin/Rscript quantile_genes_popgen_stats_density_plot_2quantiles.R HudsonRM_all HudsonRM_all 'genes_in_Agenome_genomewide,genes_in_Bgenome_genomewide,genes_in_Dgenome_genomewide' bodies 3 nucleotideDiversity_all "Diversity pi" 0.75 0.2 '%1.3f' '%3.0f' '%1.2f' 0.65
