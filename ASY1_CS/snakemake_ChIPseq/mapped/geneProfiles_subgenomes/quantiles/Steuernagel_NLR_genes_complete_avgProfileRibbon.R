...
# Usage:
# /applications/R/R-3.5.0/bin/Rscript Krasileva_NB_ARC_genes_avgProfileRibbon.R ASY1_CS_Rep1_ChIP ASY1_CS both 'genes_in_Agenome_genomewide,genes_in_Bgenome_genomewide,genes_in_Dgenome_genomewide' 'NB-ARC-encoding_genes' 3500 2000 2kb '2 kb' 20 20bp promoters
...
#                               split = ","))
#featureNamePlot <- "NB-ARC-encoding_genes"
#bodyLength <- 3500
#upstream <- 2000
#downstream <- 2000
#flankName <- "2kb"
...
####
factorColumns <- sapply(features, is.factor)
features[factorColumns] <- lapply(features[factorColumns], as.character)
####
