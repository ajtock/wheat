...
# Usage:
# /applications/R/R-3.5.0/bin/Rscript quantile_genes_intronNo_density_plot.R ASY1_CS_Rep1_ChIP ASY1_CS 'genes_in_Agenome_genomewide,genes_in_Bgenome_genomewide,genes_in_Dgenome_genomewide' promoters 4
