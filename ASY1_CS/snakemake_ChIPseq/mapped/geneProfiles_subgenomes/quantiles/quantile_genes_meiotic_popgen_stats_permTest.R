...
# Usage:
# /applications/R/R-3.5.0/bin/Rscript quantile_genes_meiotic_popgen_stats_permTest.R ASY1_CS_Rep1_ChIP ASY1_CS 'genes_in_Agenome_genomewide,genes_in_Bgenome_genomewide,genes_in_Dgenome_genomewide' 'Meiotic_genes' genes 1 3 4 TajimaD_all "Tajima's D" 10000 0.0001 '%5.2f' '4.9,4.5' '-3.0,5.0'
