...
# Usage:
# /applications/R/R-3.5.0/bin/Rscript quantile_Steuernagel_NLR_genes_complete_avgProfileRibbon.R ASY1_CS_Rep1_ChIP ASY1_CS both 'genes_in_Agenome_genomewide,genes_in_Bgenome_genomewide,genes_in_Dgenome_genomewide' 3500 2000 2kb '2 kb' 20 20bp bodies 4 100kb 1 '0.02,0.96'
