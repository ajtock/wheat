...
# Usage 
# ./proportion_clustered_in_NLR_quantiles_hypergeometricTest_HudsonRM.R 'HudsonRM_all' 'genes' 1 2 'genomewide' 'Agenome_Bgenome_Dgenome' 100000
...
genome_clust <- featuresDF[featuresDF$clustered == "yes",]$featureID
...
#    textX1 <- min(hgTestResults@hypergeomDist)/1.15
  ...
  mtext(side = 1,
        ...
        line = 1.85)
  titleText <- list(bquote("NLRs in an NLR cluster in" ~
...
ggsave(paste0(plotDir,
              "bargraph_NLR_clustered_gene_representation_among_", quantileLast,
