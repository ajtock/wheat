...
# Usage
# ./proportion_not_clustered_in_NLR_quantiles_hypergeometricTest_bargraph_only.R 'cMMb' 'genes' 1 4 'genomewide' 100000 'grey20,turquoise4,turquoise3,turquoise1'
...
#region <- "genomewide"
#samplesNum <- 100000
#genomeColours <- unlist(strsplit('grey20,turquoise4,turquoise3,turquoise1', split = ",")) 
