...
# Usage
# ./proportion_monophyletic_physically_clustered_NLRs_in_NLR_quantiles_hypergeometricTest_bargraph_only.R 'cMMb' 'genes' 1 4 'genomewide' 100000 'black,darkorange3,darkorange,goldenrod1'
...
#  scale_y_continuous(limits = c(-6.00, 6.00)) +
...
ggsave(paste0(plotDir,
              "combined_bargraph_NLR_clustered_monophyletic_gene_representation_among_", quantileLast,
