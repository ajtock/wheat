...
# Usage
# ./proportion_motifs_in_NLR_quantiles_hypergeometricTest_bargraph_only.R 'cMMb' 'genes' 1 4 'genomewide' 100000 'black,navy,dodgerblue4,deepskyblue'
...
featCatPlot <- paste0("NLR motif ", c(1:20), "-containing")
...
for(yy in seq_along(featCat)) {
  ...
  #  scale_y_continuous(limits = c(-1.5, 1.5)) +
    ...
    ggtitle(bquote(.(featCatPlot[yy]) ~ "genes in" ~
