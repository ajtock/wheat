...
# Usage
# ./proportion_disease_upreg_in_NLR_quantiles_hypergeometricTest_bargraph_only.R 'cMMb' 'genes' 1 4 'genomewide' 100000 'black,darkorange3,darkorange,goldenrod1'
...
#  scale_y_continuous(limits = c(-1.75, 0.75)) +
...
ggsave(paste0(plotDir,
              "combined_bargraph_NLR_disease_upreg_gene_representation_among_", quantileLast,
