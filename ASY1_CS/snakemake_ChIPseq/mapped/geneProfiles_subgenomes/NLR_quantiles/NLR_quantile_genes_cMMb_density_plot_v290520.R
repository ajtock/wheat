...
# Usage:
# /applications/R/R-3.5.0/bin/Rscript NLR_quantile_genes_cMMb_density_plot_v290520.R cluster_members 'NLR_genes_in_Agenome_genomewide,NLR_genes_in_Bgenome_genomewide,NLR_genes_in_Dgenome_genomewide' genes 4
...
# Define plot titles
featureNamePlot <- paste0("Cluster size ",
...
# Take top 99% of data to aid visualisation in density plots
...
ggsave(paste0(plotDir,
              ...
              paste0(substring(featureName, first = 14, last = 20),
                     collapse = "_"), "_",
              substring(featureName[1][1], first = 22), "_v290520.pdf"),
