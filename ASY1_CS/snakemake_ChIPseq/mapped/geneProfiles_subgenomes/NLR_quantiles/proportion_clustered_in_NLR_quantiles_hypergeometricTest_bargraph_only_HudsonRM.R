...
# Usage
# ./proportion_clustered_in_NLR_quantiles_hypergeometricTest_bargraph_only_HudsonRM.R 'HudsonRM_all' 'genes' 1 2 'genomewide' 100000 'black,navy,dodgerblue4,deepskyblue'
