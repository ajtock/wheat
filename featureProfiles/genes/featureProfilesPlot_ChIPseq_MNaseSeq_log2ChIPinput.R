...
# Usage:
# ./featureProfilesPlot_ChIPseq_MNaseSeq_log2ChIPinput.R both genes 20bp 20 2kb 2000 141218
...
inDir1 <- paste0("/home/ajt200/analysis/wheat/MNase/snakemake_ChIPseq/mapped/", align, "/bw/")
...
inDir9 <- paste0("/home/ajt200/analysis/wheat/epigenomics_shoot_leaf_IWGSC_2018_Science/input/snakemake_ChIPseq/mapped/", align, "/bw/")
