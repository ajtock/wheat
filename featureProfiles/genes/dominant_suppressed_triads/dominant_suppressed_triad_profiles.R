...
# Usage:
# /applications/R/R-3.5.0/bin/Rscript dominant_suppressed_triad_profiles.R 2000 2kb '2 kb' 20 20bp
...
pdf(paste0(plotDir, "dominant_suppressed_triad_profiles_HC_CS_no_stress.pdf"),
    height = 2.5*(length(sRNAmats)+length(log2ChIPmats)), width = 3)
par(mfrow = c((length(sRNAmats)+length(log2ChIPmats)), 1))
...
pdf(paste0(plotDir, "dominant_suppressed_triad_profiles_HC_Development.pdf"),
    height = 2.5*(length(sRNAmats)+length(log2ChIPmats)), width = 3)
par(mfrow = c((length(sRNAmats)+length(log2ChIPmats)), 1))
par(mar = c(2.1, 3.2, 2.1, 3.2))
par(mgp = c(2.25, 1, 0))
