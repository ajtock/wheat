...
# Usage:
# ./AxC_mapped_marker_interval_correlation_matrix_incl_distanceToCEN.R
...
profilesDF <- data.frame("Diff_cMMb" = profilesDF[,1],
                         "IWGSC_cMMb" = profilesDF[,(ncol(profilesDF)-1)],
                         "Dist_to_CEN" = profilesDF[,ncol(profilesDF)],
                         profilesDF[,c(-1,-(ncol(profilesDF)-1),-ncol(profilesDF))])
...
ggsave(paste0(plotDir,
              "Spearman_correlation_matrix_AxC_mapped_marker_intervals_mean_ChIPseq_DNAmethyl_cMMb_distanceToCEN_qVals.pdf"),
