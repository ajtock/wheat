...
# Usage:
# ./analyse_differential_excl_interactions.R
...
dat <- dat[,-which(colnames(dat) %in% c("cMMb_1Mb", "distToCEN"))]
...
colnames(glmNormal_l2fc_fancm_wt_cMMb_inter_coeffs_df) <- c("Variable", "Estimate", "Standard_error", "t-value", "Pr(>|t|)")
...
for(i in unique(dat$chr)) {
  ...
  if(i == unique(dat$chr)[1]) {
    mtext(side = 3, line = 2, cex = 0.75,
          text = "Normal GLM: L2FC cM/Mb~(IWGSC cM/Mb+ASY1+DMC1+H3K4me1+H3K4me3+H3K27ac+H3K27me3+H3K36me3+H3K9me2+H3K27me1+CENH3+mCG+mCHG+mCHH)")
...
colnames(glmNormal_l2fc_fancm_wt_cM_inter_coeffs_df) <- c("Variable", "Estimate", "Standard_error", "t-value", "Pr(>|t|)")
...
for(i in unique(dat$chr)) {
  ...
  if(i == unique(dat$chr)[1]) {
    mtext(side = 3, line = 2, cex = 0.75,
          text = "Normal GLM: L2FC cM~(IWGSC cM/Mb+ASY1+DMC1+H3K4me1+H3K4me3+H3K27ac+H3K27me3+H3K36me3+H3K9me2+H3K27me1+CENH3+mCG+mCHG+mCHH+width)")
    mtext(side = 3, line = 0.5, cex = 0.75,
...
colnames(glmNormal_diff_fancm_wt_cMMb_inter_coeffs_df) <- c("Variable", "Estimate", "Standard_error", "t-value", "Pr(>|t|)")
...
for(i in unique(dat$chr)) {
  ...
  if(i == unique(dat$chr)[1]) {
    mtext(side = 3, line = 2, cex = 0.75,
          text = "Normal GLM: Differential cM/Mb~(IWGSC cM/Mb+ASY1+DMC1+H3K4me1+H3K4me3+H3K27ac+H3K27me3+H3K36me3+H3K9me2+H3K27me1+CENH3+mCG+mCHG+mCHH)")
    mtext(side = 3, line = 0.5, cex = 0.75,
...
colnames(glmNormal_diff_fancm_wt_cM_inter_coeffs_df) <- c("Variable", "Estimate", "Standard_error", "t-value", "Pr(>|t|)")
...
for(i in unique(dat$chr)) {
  ...
  if(i == unique(dat$chr)[1]) {
    mtext(side = 3, line = 2, cex = 0.75,
          text = "Normal GLM: Differential cM~(IWGSC cM/Mb+ASY1+DMC1+H3K4me1+H3K4me3+H3K27ac+H3K27me3+H3K36me3+H3K9me2+H3K27me1+CENH3+mCG+mCHG+mCHH+width)")
    mtext(side = 3, line = 0.5, cex = 0.75,
