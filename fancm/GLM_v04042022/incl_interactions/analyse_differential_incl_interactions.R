...
for(i in unique(dat$chr)) {
  ...
  if(i == unique(dat$chr)[1]) {
    mtext(side = 3, line = 2, cex = 0.75,
          text = "Normal GLM: L2FC cM/Mb~(IWGSC cM/Mb+ASY1+DMC1+H3K4me1+H3K4me3+H3K27ac+H3K27me3+H3K36me3+H3K9me2+H3K27me1+CENH3+mCG+mCHG+mCHH)^2")
...
for(i in unique(dat$chr)) {
  ...
  if(i == unique(dat$chr)[1]) {
    mtext(side = 3, line = 2, cex = 0.75,
          text = "Normal GLM: L2FC cM~(IWGSC cM/Mb+ASY1+DMC1+H3K4me1+H3K4me3+H3K27ac+H3K27me3+H3K36me3+H3K9me2+H3K27me1+CENH3+mCG+mCHG+mCHH+width)^2")
    mtext(side = 3, line = 0.5, cex = 0.75,
...
for(i in unique(dat$chr)) {
  ...
  if(i == unique(dat$chr)[1]) {
    mtext(side = 3, line = 2, cex = 0.75,
          text = "Normal GLM: Differential cM/Mb~(IWGSC cM/Mb+ASY1+DMC1+H3K4me1+H3K4me3+H3K27ac+H3K27me3+H3K36me3+H3K9me2+H3K27me1+CENH3+mCG+mCHG+mCHH)^2")
    mtext(side = 3, line = 0.5, cex = 0.75,
...
for(i in unique(dat$chr)) {
  ...
  if(i == unique(dat$chr)[1]) {
    mtext(side = 3, line = 2, cex = 0.75,
          text = "Normal GLM: Differential cM~(IWGSC cM/Mb+ASY1+DMC1+H3K4me1+H3K4me3+H3K27ac+H3K27me3+H3K36me3+H3K9me2+H3K27me1+CENH3+mCG+mCHG+mCHH+width)^2")
    mtext(side = 3, line = 0.5, cex = 0.75,
