...
# Usage:
# ./cMMb_iwgsc_refseqv1.0_mapping_data_removeProblemMarkers_calcAdjacentWincMMb_alt.R 1Mb 1000000 200 15
...
# Remove second marker for marker pairs with negative genetic distances
...
write.table(filt_cMMbProfile,
            file = paste0("cMMb_iwgsc_refseqv1.0_mapping_data_minInterMarkerDist",
                          as.character(minMarkerDist), "bp_", winName, "_smoothed_alt.txt"),
            sep = "\t", quote = F, row.names = F, col.names = T)
