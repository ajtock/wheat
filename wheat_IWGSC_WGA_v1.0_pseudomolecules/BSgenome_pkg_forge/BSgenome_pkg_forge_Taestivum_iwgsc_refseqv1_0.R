...
# Usage:
# ./BSgenome_pkg_forge_Taestivum_iwgsc_refseqv1_0.R iwgsc_refseqv1_0

args <- commandArgs(trailingOnly = T)
# packageNamePt4 refers to the character string after the third "." in, e.g.,
# BSgenome.Taestivum.Cambridge.iwgsc_refseqv1_0 (i.e., iwgsc_refseqv1_0)
...
Ta_iwgsc_refseqv1_0_seed <- list.files(seed_files,
                                       pattern = paste0("\\.", packageNamePt4, "-seed$"),
                                       full.names = TRUE)
cat(readLines(Ta_iwgsc_refseqv1_0_seed), sep = "\n")

forgeBSgenomeDataPkg(Ta_iwgsc_refseqv1_0_seed)
