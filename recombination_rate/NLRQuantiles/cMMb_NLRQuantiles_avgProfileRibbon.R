...
# Usage:
#./cMMb_NLRQuantiles_avgProfileRibbon.R 100kb 1 4 ASY1_CS ASY1_CS_Rep1_ChIP input H3_input_SRR6350669 both purple4 NLRs NLRs 20bp 20 2kb '2 kb' 2000 'euchromatin' '0.38,0.96'
...
# NLRs
genes <- read.table("/home/ajt200/analysis/wheat/annotation/221118_download/iwgsc_refseqv1.1_manually_curated_gene_families/IWGSC_v1.1_nlr_representative_mRNA.gff3",
                    colClasses = c(NA,
                                   rep("NULL", 2),
                                   rep(NA, 2),
                                   "NULL", NA, "NULL", NA))
